...
urlpatterns = [
   ...
   # path('auth/get/patient' , PatientList.as_view() , name='Patient_list'),
    ...
    path('auth/get/patient/<int:patient_id>/dpi' , DPIView.as_view() , name='dpi-detail'),
    ...
    path('auth/register/medcin/patients/<int:patient_id>/dpi', DPIView.as_view(), name='dpi-detail'),
   ...
   # path('auth/register/medcin/patients/dpi-id/dpi/consultations',DPIConsultationListView.as_view(), name='consultation-list'),
    path('auth/register/medcin/patients/<int:patient_id>/dpi/consultations/',DPIConsultationListView.as_view(), name='consultation-list'),
    path('auth/register/medcin/patients/<int:patient_id>/consultations/<int:cons_id>',ConsultationView.as_view(), name='consultation'),
